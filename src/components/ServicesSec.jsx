        ...
        <section className={'services-section ' + props.borderBottom}>            
            ...
            <div className="d-block d-sm-flex gap-2 mb-2">
                <div className="col text-center border rounded d-flex flex-column p-2 mb-2">
                    <div>
                        <FontAwesomeIcon className='fs-3 btn btn-primary p-2' icon="laptop-code" />
                    </div>
                ...
                <div className="col text-center border rounded d-flex flex-column p-2 mb-2">
                    <div>
                        <FontAwesomeIcon className='fs-3 btn btn-primary p-2' icon="mobile-alt" />
                    </div>
            ...
            <div className="d-block d-sm-flex gap-2 mb-2">
                <div className="col text-center border rounded d-flex flex-column p-2 mb-2">
                    <div>
                        <FontAwesomeIcon className='fs-3 btn btn-primary p-2' icon="palette" />
                    </div>
                ...
                <div className="col text-center border rounded d-flex flex-column p-2 mb-2">
                    <div>
                        <FontAwesomeIcon className='fs-3 btn btn-primary p-2' icon="bullhorn" />
                    </div>
