  ...
  return (
    <div>
      <section className={'px-md-2 ' + props.borderBottom}>
        ...
        <h2>
          I' m Tochukwu Elekwachi a{' '}
          <span className='text-custom-color fw-bold fs-1'>Software Developer</span>
        </h2>

        <p className='fs-5'>
          I am a results-driven Software Developer with a strong passion for building scalable,
          efficient, and user-centric applications. With expertise in web development, software
          architecture, and modern programming frameworks, I create seamless digital solutions that
          enhance user experience and drive business growth. I thrive in collaborative environments,
          leveraging problem-solving skills and industry best practices to develop high-quality,
          maintainable code. Committed to continuous learning and staying ahead of emerging
          technologies, I am eager to contribute my skills to innovative projects. Let’s connect and
            ...
            <div className="position-relative border rounded p-3 ps-5">
              <div className="css-line">
                ...
                <span className="small">
                  <FontAwesomeIcon icon={faGraduationCap} /> During Studies
                </span>
                <h5 className="my-2">Enugu State University of Science and Technology (ESUT)</h5>
                <p className="timeline_text">
                  Earned a Bachelor's Degree in Computer Science, gaining in-depth knowledge in
              ...
              <div className="css-line">
                <div className="circle-dot bg-custom-color rounded-circle"></div>
                <span className="small">
                  <FontAwesomeIcon icon={faGraduationCap} /> Training Period
                </span>
                <h5 className="my-2">Abia Tech Hub (ATH)</h5>
                <p className="timeline_text">
                  Specialized in Full-Stack Development, mastering modern web technologies and
          ...
          <div className="col-md-6">
            ...
            <div className="position-relative border rounded p-3 ps-5">
              <div className="css-line">
                <div className="circle-dot bg-custom-color rounded-circle"></div>
                <span className="small">
                  <FontAwesomeIcon icon={faBriefcase} /> Ongoing
                </span>
                <h5 className="my-2">Full Stack Developer</h5>
                <p className="timeline_text">
                  Experienced in Full Stack Development, from front-end design to back-end
                  architecture. Skilled in JavaScript (React, Vue, Next.js), Node.js (Express), and
              ...
              <div className="css-line">
                ...
                <p className="timeline_text">
                  Designing and developing scalable software solutions, ensuring optimal system
                  performance and seamless user experiences. Proficient in PHP (Laravel), Python
                  (Django, Flask), and cloud technologies like AWS.
                </p>
              </div>
            </div>
          </div>
