...
//         <button className="btn border text-body dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"><FontAwesomeIcon icon={faCog} spin className='fs-4' /></button>
