        ...
        <section className={'portfolio-section ' + props.borderBottom}>
            ...
            <div className="row">
                <div className="col-md-4">
                    <img src={GIGM} alt="Portfolio" className='w-100 mb-3 border-5 rounded' />
                    <img src={netflix} alt="Portfolio" className='w-100 mb-3 border-5 rounded' />
                </div>
                <div className="col-md-4">
                    <img src={login} alt="Portfolio" className='w-100 mb-3 border-5 rounded' />
                    <img src={web} alt="Portfolio" className='w-100 mb-3 border-5 rounded' />
                </div>
                <div className="col-md-4">
                    <img src={policify} alt="Portfolio" className='w-100 mb-3 border-5 rounded' />
                    <img src={transport} alt="Portfolio" className='w-100 mb-3 border-5 rounded' />
                </div>
            </div>
        </section>
    </div>
